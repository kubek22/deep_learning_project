...
def train_with_augmentation(n, init_model, epochs, train_dataloader, val_dataloader, test_dataloader, device, batchsize, lr=0.001, drop=0.5, beta=(0.9,0.999), aug=None, weight_decay=0):
